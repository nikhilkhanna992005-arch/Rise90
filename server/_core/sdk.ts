...
class OAuthService {
  constructor(private client: ReturnType<typeof axios.create>) {
    if (ENV.oAuthServerUrl) {
      ...
      console.log("[OAuth] Notice: OAUTH_SERVER_URL is not configured. Email/Password authentication active.");
    }
  }
...
class SDKServer {
  ...
  private getSessionSecret() {
    const secret = ENV.cookieSecret || "rise90_default_jwt_secret_key_32bytes!";
  ...
  async signSession(
    ...
    return new SignJWT({
      ...
      appId: payload.appId || "rise90_app",
  ...
  async verifySession(
    ...
    try {
      ...
      return {
        openId,
        appId: typeof appId === "string" && appId ? appId : "rise90_app",
